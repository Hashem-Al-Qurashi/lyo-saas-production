...
from management.routes import treatments, operators, hours, settings as settings_routes, appointments, users, calendar, onboarding, faq, superadmin, instagram  # noqa: E402
...
mgmt_app.include_router(instagram.router)
