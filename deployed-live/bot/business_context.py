...
def _build_operators_section(operators: list) -> str:
    ...
    lines.append("   - AUTO-ADDON rule (Bug #14): When a service includes an automatic addon (e.g. Taglio + Piega),")
    lines.append("     NEVER say which operator performs the addon. Just confirm the full service name.")
